#!/bin/bash -l
#SBATCH --job-name=ques              # Job name
#SBATCH --output=train-logs-q/o%A_%a     # Name of stdout output file
#SBATCH --error=train-logs-q/e%A_%a      # Name of stderr error file
...
singularity exec --bind /scratch/project_465001339,/project/project_465001339 ${SIF} \
    python augmentation/gen_questions.py \
